...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapawesomeCapacitorNavigationBar", path: "../../../../../node_modules/.pnpm/@capawesome+capacitor-navigation-bar@8.0.1_@capacitor+core@8.4.2/node_modules/@capawesome/capacitor-navigation-bar")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
